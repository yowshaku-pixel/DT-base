        ...
        <div className="absolute top-4 right-4 flex items-center gap-2 z-10">
          {viewMode === 'log' && (
            <button 
              ...
              className={cn(
                "p-2 bg-surface border border-border hover:bg-white/10 transition-all rounded-full text-muted hover:text-text hover:neon-glow-violet flex items-center justify-center cursor-pointer outline-none",
                theme === 'pro' ? "focus-visible:ring-2 focus-visible:ring-indigo-500" : "focus-visible:ring-2 focus-visible:ring-purple-500"
              )}
              title="Open Settings"
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
                <motion.button
                  type="button"
                  className={cn(
                    "p-3.5 rounded-2xl border relative overflow-hidden flex items-center justify-center cursor-pointer outline-none transition-all",
                    theme === 'pro'
                      ? "bg-indigo-500/10 border-indigo-500/30 shadow-[0_0_20px_rgba(99,102,241,0.2)] focus-visible:ring-2 focus-visible:ring-indigo-500"
                      : "bg-purple-600/20 border-purple-500/35 shadow-[0_0_20px_rgba(168,85,247,0.2)] focus-visible:ring-2 focus-visible:ring-purple-500"
                  )}
