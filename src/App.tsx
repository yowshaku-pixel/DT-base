        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
                <motion.button
                  ...
                  className={cn(
                    "p-3.5 rounded-2xl border relative overflow-hidden flex items-center justify-center cursor-pointer focus-visible:ring-2 focus-visible:ring-purple-500 dark:focus-visible:ring-indigo-500 outline-none",
            ...
            <AnimatePresence>
              {notification && (
                <motion.div
                  ...
                  className={cn(
                    "p-4 rounded-2xl border flex items-center gap-3 shadow-xl pointer-events-auto min-w-[300px]",
                    ...
                    "bg-amber-700/10 border-amber-500/30 text-amber-700 dark:text-amber-200"
                  )}
                  role="status"
                  aria-live="polite"
                >
