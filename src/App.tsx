      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            className={cn(
              "fixed bottom-24 md:bottom-8 right-6 z-40 p-4 bg-purple-600 hover:bg-purple-500 text-white rounded-2xl shadow-xl shadow-purple-900/40 border border-purple-400/30 transition-all active:scale-95 group focus-visible:ring-2 outline-none",
              theme === 'pro' ? "focus-visible:ring-indigo-500" : "focus-visible:ring-purple-500"
            )}
            title="Scroll to top"
