...
export default function App() {
  ...
  return (
    <div className={cn(
      ...
      {/* Non-blocking persistent notifications */}
      <div className="fixed top-6 right-6 z-[150] pointer-events-none flex flex-col gap-3 items-end">
        <AnimatePresence>
          {notification && (
            <motion.div
              ...
              aria-live="polite"
              className={cn(
                "p-4 rounded-2xl border flex items-center gap-3 shadow-2xl pointer-events-auto min-w-[280px] max-w-md",
                ...
                notification.type === 'warning' && "bg-amber-500/10 border-amber-500/30 text-amber-700 dark:text-amber-200",
                notification.type === 'error' && "bg-red-500/10 border-red-500/30 text-red-700 dark:text-red-200"
              )}
            >
              {notification.type === 'info' && <Loader2 className="w-4 h-4 animate-spin text-purple-500" />}
              ...
              <span className="text-xs font-display font-bold uppercase tracking-widest flex-1">{notification.message}</span>
        ...
        <div className="absolute top-4 right-4 flex items-center gap-2 z-10">
          {viewMode === 'log' && (
            <button 
              ...
              className="p-2 bg-surface border border-border hover:bg-white/10 transition-all rounded-full text-muted hover:text-text hover:neon-glow-violet flex items-center justify-center cursor-pointer focus-visible:ring-2 focus-visible:ring-purple-500 outline-none"
              title="Open Settings"
