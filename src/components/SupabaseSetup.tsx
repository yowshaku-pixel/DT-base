    ...
    <div className="space-y-4">
      ...
      <div className="p-5 bg-cyan-500/[0.03] border border-cyan-500/20 rounded-3xl space-y-4 shadow-md">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-black/60 border border-white/10 p-3.5 pl-11 font-mono text-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 text-white rounded-2xl placeholder:text-white/10 transition-all select-all text-cyan-200"
        ...
        <button 
          ...
          className="w-full py-3 bg-cyan-600 hover:bg-cyan-500 text-white font-display font-bold uppercase tracking-widest text-[10px] rounded-xl transition-all shadow-lg shadow-cyan-900/20 active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
        >
