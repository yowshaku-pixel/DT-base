        ...
        {isServiceUnlocked ? (
          showFleetRegistryList ? (
            <div className="p-4 bg-white/5 border border-white/10 rounded-2xl space-y-3">
              <label htmlFor="fleet-registry-input" className="text-[9px] text-white/40 uppercase tracking-widest leading-relaxed block">
              ...
              <textarea 
                ...
                className="w-full h-32 bg-black/40 border border-white/10 rounded-xl p-3 font-mono text-xs text-cyan-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus:border-cyan-500/50 transition-all resize-none"
                placeholder="E.G.&#10;KCL 054&#10;KCY 901B&#10;UAY 469L..."
              />
        ...
        <div className="p-5 bg-white/[0.02] border border-white/5 rounded-3xl space-y-4">
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-4 gap-1" role="group" aria-label="Report Category">
                {(['app', 'ocr', 'sync', 'other'] as const).map((cat) => (
                  <button
                    ...
                    className={cn(
                      "py-1.5 rounded-lg text-[8px] font-display font-bold uppercase tracking-widest transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500",
                      bugCategory === cat 
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full h-24 bg-black/60 border border-white/10 rounded-2xl p-3.5 font-sans text-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus:border-purple-500/50 text-white placeholder:text-white/10 transition-all resize-none"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-black/60 border border-white/10 rounded-xl p-3 font-mono text-xs text-cyan-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus:border-cyan-500/50 transition-all placeholder:text-white/10"
                />
                <button
                  type="button"
        ...
        <div className="p-5 bg-red-500/[0.02] border border-red-500/10 rounded-3xl space-y-4">
          ...
          {dangerAction && (
            <div className="mt-4 p-4 bg-red-950/20 border border-red-500/30 rounded-2xl space-y-3.5 animate-in slide-in-from-top-3 duration-300">
              ...
              <div className="space-y-2">
                <label htmlFor="danger-zone-password" className="sr-only">Password Confirmation</label>
                <input 
                  id="danger-zone-password"
                  type="password"
                  placeholder="ENTER PASSWORD FOR AUTH..."
                  className="w-full bg-black/50 border border-red-500/20 p-3 rounded-xl font-mono text-xs text-red-200 uppercase tracking-wider focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus:border-red-500/50"
