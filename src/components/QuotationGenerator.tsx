            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-surface border border-border p-3 pl-12 rounded-xl text-sm text-text focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                />
              </div>
            </div>
            <div className="space-y-2">
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <button 
                        ...
                        className="p-1 text-white/20 hover:text-red-400 transition-colors md:opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 rounded"
                      >
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent border-none p-0 text-sm text-white placeholder:text-white/10 focus:ring-0 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-purple-500 rounded"
                    />
                  </div>
                  <div className="flex gap-3 items-end">
                    <div className="w-20 space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full bg-white/5 border border-white/10 p-2 rounded-lg text-xs text-white text-center focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                    </div>
                    <div className="w-32 space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full bg-white/5 border border-white/10 p-2 rounded-lg text-xs text-white text-right focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                    </div>
                  </div>
                </div>
