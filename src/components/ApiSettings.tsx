  ...
  return (
    <>
      <button
        ...
        className="p-2 bg-white/5 border border-white/10 text-white/60 hover:text-purple-400 hover:bg-white/10 transition-all rounded active:scale-95 flex items-center gap-2"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-[#121214] border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-sm font-display font-bold uppercase tracking-widest">API Configuration</h2>
                  <p className="text-[10px] text-white/40 uppercase tracking-wider">Manage your extraction limits</p>
                </div>
              </div>
              <button 
              ...
              <div className="p-4 bg-purple-500/5 border border-purple-500/20 rounded-xl space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-3 text-xs font-mono text-purple-200 placeholder:text-white/10 focus:outline-none focus:border-purple-500/50 transition-colors"
                  />
                </div>
              </div>
            ...
            <div className="p-6 bg-black/40 border-t border-white/5 flex justify-end gap-3">
              <button
                onClick={() => setIsOpen(false)}
                className="px-4 py-2 text-[10px] font-display font-bold uppercase tracking-widest text-white/40 hover:text-white transition-colors"
              >
                Cancel
              </button>
              <button
