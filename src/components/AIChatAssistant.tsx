  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={cn(
          "fixed bottom-6 right-[6rem] z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(160,32,240,0.4)] transition-all border outline-none focus-visible:ring-2",
          ringClass,
          isOpen 
          ...
          >
            ...
            <div className="px-4 py-2 border-b border-border bg-surface flex items-center justify-between">
              ...
              <button 
                ...
                className={cn(
                  "px-3 py-1 rounded-full text-[8px] font-display font-bold uppercase tracking-widest transition-all border outline-none focus-visible:ring-2",
                  ringClass,
                  isShortMode 
              ...
              {isLoading && (
                <div className="flex items-center justify-between gap-2 p-2 bg-purple-600/10 border border-purple-500/20 rounded-lg animate-pulse">
                  ...
                  <button 
                    onClick={handleStop}
                    className={cn(
                      "px-2 py-1 bg-red-500/20 hover:bg-red-500/40 text-red-400 text-[9px] font-bold uppercase rounded transition-colors outline-none focus-visible:ring-2",
                      ringClass
                    )}
                  >
                    Stop
            ...
            <form onSubmit={handleSend} className="p-4 border-t border-border bg-surface/50">
              <div className="relative flex items-end gap-2">
                ...
                <button
                  ...
                  className={cn(
                    "mb-1 p-2.5 bg-gradient-to-br from-violet-600 to-cyan-500 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:from-violet-500 hover:to-cyan-400 transition-all shadow-[0_0_15px_rgba(0,245,255,0.3)] shrink-0 outline-none focus-visible:ring-2",
                    ringClass
                  )}
                >
